...
const BrandForm: React.FC<BrandFormProps> = ({ initial, onSubmit, onCancel, loading, submitLabel }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6 space-y-4 bg-white p-4 rounded shadow">
      ...
      <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded" disabled={loading}>{submitLabel || 'Save Brand'}</button>
