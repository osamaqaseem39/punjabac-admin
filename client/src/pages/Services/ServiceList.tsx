  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link to="/services/add" className="bg-blue-600 text-white px-5 py-2 rounded-lg shadow hover:bg-blue-700 transition">Add Service</Link>
      </div>
      {loading ? (
            ...
            {services.map(service => (
              <div key={service._id} className="bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-4 flex flex-col hover:shadow-2xl transition-shadow">
                ...
                <div className="mt-auto flex gap-2">
                  <Link to={`/services/${service._id}`} className="px-3 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200 transition">View</Link>
